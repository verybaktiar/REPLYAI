        ...
        <div class="flex-1 overflow-y-auto p-6 lg:p-8 scroll-smooth">
            <div class="max-w-4xl mx-auto flex flex-col gap-6">
                ...
                <div class="grid grid-cols-4 gap-4">
                    <div class="bg-white dark:bg-surface-dark rounded-xl border border-slate-200 dark:border-slate-800 p-4 text-center shadow-sm">
                ...
                <!-- Enrollments Table -->
                <div class="bg-white dark:bg-surface-dark rounded-xl border border-slate-200 dark:border-slate-800 overflow-hidden shadow-sm">
...
<div id="enroll-modal" class="hidden fixed inset-0 z-50">
    ...
    <div class="absolute inset-0 flex items-center justify-center p-4">
        <div class="w-full max-w-md rounded-2xl bg-white dark:bg-surface-dark border border-slate-200 dark:border-slate-700 shadow-2xl">
