...
<main class="flex-1 flex flex-col h-full overflow-hidden">
    <div class="p-6 lg:p-8 overflow-auto">
        <div class="max-w-2xl mx-auto">
            ...
            <!-- Header -->
            <div class="mb-8">
                <h1 class="text-2xl font-bold text-white mb-2">Pengaturan Instagram</h1>
                <p class="text-gray-400">Hubungkan akun Instagram Business Anda untuk menerima dan membalas DM otomatis.</p>
            </div>
            ...
            <div class="bg-gray-800 rounded-2xl border border-gray-700 overflow-hidden">
                    ...
                    <div class="p-6">
                        <div class="flex items-center gap-4 mb-6">
                            ...
                            <div class="flex-1">
                                <div class="flex items-center gap-2 mb-1">
                                    ...
                                    <span class="px-2 py-0.5 bg-green-500/20 text-green-400 rounded-full text-xs font-semibold">Terhubung</span>
                                </div>
                        ...
                        <div class="bg-gray-900 rounded-xl p-4 mb-6">
                            <div class="flex items-center justify-between">
                                <div>
                                    <p class="text-sm text-gray-400">Status Token</p>
                                    @if($instagramAccount->isTokenExpired())
                                    <p class="text-red-400 font-medium">⚠️ Token Expired - Perlu Reconnect</p>
                                    @elseif($instagramAccount->isTokenExpiringSoon())
                                    <p class="text-yellow-400 font-medium">⚠️ Token akan expired dalam 7 hari</p>
                                    @else
                                    <p class="text-green-400 font-medium">✓ Token Aktif</p>
                                    @endif
                                </div>
                        ...
                        <div class="flex gap-3">
                            ...
                            <form action="{{ route('instagram.disconnect') }}" method="POST" class="flex-1" onsubmit="return confirm('Yakin ingin memutuskan koneksi Instagram?')">
                                @csrf
                ...
                @else
                    ...
                    <div class="p-8 text-center">
                        ...
                        <h3 class="text-xl font-bold text-white mb-2">Hubungkan Instagram</h3>
                        ...
                        <div class="bg-yellow-500/10 border border-yellow-500/30 rounded-xl p-4 text-left">
                            <p class="text-yellow-400 font-semibold mb-2">⚠️ Belum Dikonfigurasi</p>
                            <p class="text-gray-400 text-sm">Instagram OAuth belum dikonfigurasi. Hubungi administrator untuk setup Meta App credentials.</p>
                        </div>
                        @endif
                    </div>
                @endif
            ...
            <div class="mt-6 bg-gray-800/50 rounded-xl p-4 border border-gray-700">
                <h4 class="text-sm font-semibold text-white mb-2">📋 Persyaratan:</h4>
                <ul class="text-sm text-gray-400 space-y-1">
                    <li>• Akun Instagram harus tipe <strong>Business</strong> atau <strong>Creator</strong></li>
                    <li>• Akun harus terhubung ke Facebook Page (untuk Professional accounts)</li>
                    <li>• Anda harus mengizinkan ReplyAI untuk mengakses DM</li>
                </ul>
            </div>

            <!-- How it Works -->
            <div class="mt-6 bg-gray-800/50 rounded-xl p-4 border border-gray-700">
                <h4 class="text-sm font-semibold text-white mb-3">🔄 Cara Kerja:</h4>
