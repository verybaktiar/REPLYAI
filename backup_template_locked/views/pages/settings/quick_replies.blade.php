...
@include('components.sidebar')
    ...
    <main class="flex-1 flex flex-col h-full overflow-hidden relative pt-14 lg:pt-0">
        <!-- Header -->
        <header class="hidden lg:flex h-16 items-center justify-between px-6 border-b border-slate-800 bg-white/50 dark:bg-background-dark/50 backdrop-blur-sm sticky top-0 z-20">
        ...
        <div class="flex-1 overflow-y-auto p-6 scroll-smooth">
            <div class="max-w-5xl mx-auto">
                ...
                <div class="bg-surface-dark rounded-xl border border-slate-800 shadow-sm overflow-hidden">
                    <table class="w-full text-left text-sm">
                        <thead class="bg-slate-50 dark:bg-slate-800/50 text-slate-500 dark:text-slate-400 font-medium border-b border-slate-800">
                            <tr>
...
<div id="addModal" class="hidden fixed inset-0 z-50 bg-black/50 backdrop-blur-sm flex items-center justify-center p-4">
    <div class="bg-surface-dark rounded-xl shadow-xl max-w-lg w-full p-6 animate-scale-up">
            ...
            <div class="space-y-4">
                <div>
                    ...
                    <div class="relative">
                        ...
                        <input type="text" name="shortcut" id="shortcutInput" placeholder="greeting" class="w-full bg-slate-50 dark:bg-background-dark border border-slate-700 rounded-lg py-2 pl-6 pr-3 text-sm focus:ring-2 focus:ring-primary focus:border-primary dark:text-white">
                    </div>
                ...
                <div>
                    ...
                    <textarea name="message" id="messageInput" rows="4" required class="w-full bg-slate-50 dark:bg-background-dark border border-slate-700 rounded-lg p-3 text-sm focus:ring-2 focus:ring-primary focus:border-primary dark:text-white" placeholder="Tulis template balasan di sini..."></textarea>
                </div>
