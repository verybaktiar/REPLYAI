...
<template id="step-template">
    <div class="step-item bg-slate-50 dark:bg-slate-800/50 rounded-lg border border-slate-700/50 p-4" data-step-index="">
                ...
                <div class="grid grid-cols-2 gap-3">
                    <div>
                        ...
                        <select name="steps[INDEX][delay_type]" 
                                class="w-full bg-white dark:bg-slate-700 border border-slate-600 rounded-lg px-3 py-2 text-sm dark:text-white text-slate-900 focus:ring-2 focus:ring-primary/50 focus:border-primary/50">
