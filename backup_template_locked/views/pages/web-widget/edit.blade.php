    ...
    <main class="flex-1 flex flex-col h-full overflow-hidden relative">
        ...
        <div class="flex-1 overflow-y-auto p-6 lg:p-8 scroll-smooth">
            <div class="max-w-2xl mx-auto flex flex-col gap-6">
                <!-- Form -->
                <form action="{{ route('web-widgets.update', $widget) }}" method="POST" class="bg-surface-dark rounded-xl border border-slate-800 overflow-hidden shadow-sm">
                    @csrf
                    @method('PUT')
                    ...
                    <div class="p-6 space-y-6">
                        ...
                        <div>
                            ...
                            <div class="flex gap-2">
                                <input type="text" value="{{ $widget->api_key }}" readonly
                                       class="flex-1 bg-slate-100 dark:bg-slate-800 border border-slate-700 rounded-lg px-4 py-3 text-slate-500 dark:text-slate-400 font-mono text-sm"/>
                                <button type="button" onclick="copyApiKey()" 
                                        class="px-4 py-2 bg-slate-100 dark:bg-slate-700 text-slate-600 dark:text-slate-300 border border-slate-600 rounded-lg hover:bg-slate-200 dark:hover:bg-slate-600 transition-colors">
                        ...
                        <!-- Status Toggle -->
                        <div class="flex items-center justify-between p-4 bg-slate-50 dark:bg-slate-800/50 rounded-lg border border-slate-700/50">
                            <div>
                    ...
                    <!-- Actions -->
                    <div class="px-6 py-4 bg-slate-50 dark:bg-slate-800/30 border-t border-slate-700/50 flex justify-between">
                ...
                <div class="bg-surface-dark rounded-xl border border-slate-800 p-6 shadow-sm">
                    ...
                    <div class="relative">
                        <pre id="embed-code" class="bg-slate-100 dark:bg-slate-800 rounded-lg p-4 text-xs text-green-600 dark:text-green-400 overflow-x-auto border border-slate-700 font-mono">{{ $widget->embed_code }}</pre>
