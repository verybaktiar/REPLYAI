            ...
            <div class="max-w-6xl mx-auto flex flex-col gap-8">
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
                    @forelse($widgets as $widget)
                        <div class="bg-surface-dark rounded-xl border border-slate-800 overflow-hidden hover:border-primary dark:hover:border-primary transition-colors shadow-sm">
                            <!-- Widget Header -->
...
<div id="embed-modal" class="hidden fixed inset-0 z-50 flex items-center justify-center bg-black/70">
    <div class="bg-surface-dark rounded-xl border border-slate-700 w-full max-w-lg mx-4 overflow-hidden shadow-2xl">
        ...
        <div class="p-4">
            ...
            <div class="relative">
                <pre id="embed-code-content" class="bg-slate-100 dark:bg-slate-800 rounded-lg p-4 text-xs text-green-600 dark:text-green-400 overflow-x-auto border border-slate-700 font-mono"></pre>
